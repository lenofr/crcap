...
$pageTitle  = 'Segurança da Informação · CRCAP';
$activeMenu = 'governanca';
$pageSlug   = 'seguranca-informacao';
$icon       = 'fa-shield-alt';
...
<div class="bg-white rounded-2xl p-8 border border-[#001644]/06 shadow-sm text-center">
    <div class="w-16 h-16 rounded-2xl bg-gradient-to-br from-[#001644]/5 to-[#BF8D1A]/10 flex items-center justify-center mx-auto mb-4">
        <i class="fas fa-shield-virus text-2xl text-[#BF8D1A]"></i>
    </div>
    <h2 class="text-xl font-bold text-[#001644] mb-3">Segurança da Informação</h2>
...
<section class="bg-gradient-to-br from-[#001644] via-[#022E6B] to-[#001644] text-white py-12 relative overflow-hidden">
    ...
    <div class="container mx-auto px-4 relative z-10">
        <div class="flex items-center gap-2 text-white/50 text-xs mb-5">
            ...
            <span class="text-[#BF8D1A]">Segurança da Informação</span>
        </div>
        <div class="flex items-start gap-5">
            ...
            <div>
                <h1 class="font-serif text-3xl md:text-4xl font-bold mb-2">Segurança da Informação</h1>
                <p class="text-white/70 text-sm max-w-2xl">Política de segurança da informação e proteção de dados institucionais.</p>
            </div>
        </div>
    </div>
</section>
