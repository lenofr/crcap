...
$page = dbQueryOne("SELECT * FROM pages WHERE slug = 'sistema-eventos' AND status = 'published'");
include __DIR__ . '/../../includes/header.php';
$bannerTitle     = 'Sistema de Eventos';
$bannerSubtitle  = 'Acesse e gerencie eventos e inscrições';
$bannerIcon      = 'fa-calendar-alt';
$bannerBreadcrumb = [['Home','/index.php'],['Des. Profissional',null],['Sistema de Eventos',null]];
...
<div class="grid lg:grid-cols-4 gap-8">
    ...
    <div class="lg:col-span-3">
        ...
        <div class="bg-white rounded-2xl border border-[#001644]/5 p-12 text-center">
            <div class="w-16 h-16 bg-[#001644]/8 rounded-2xl flex items-center justify-center mx-auto mb-4 text-2xl text-[#001644]"><i class="fas fa-calendar-alt"></i></div>
            <h2 class="text-xl font-bold text-[#001644] mb-3">Sistema de Eventos</h2>
            <p class="text-sm text-[#001644]/60 max-w-lg mx-auto">Acesse e gerencie eventos e inscrições</p>
