...
$page = dbQueryOne("SELECT * FROM pages WHERE slug = 'educacao-continuada' AND status = 'published'");
include __DIR__ . '/../../includes/header.php';
$bannerTitle     = 'Educação Continuada';
$bannerSubtitle  = 'Mantenha-se atualizado com o programa de educação continuada';
$bannerIcon      = 'fa-book';
$bannerBreadcrumb = [['Home','/index.php'],['Des. Profissional',null],['Educação Continuada',null]];
...
<div class="grid lg:grid-cols-4 gap-8">
    ...
    <div class="lg:col-span-3">
        ...
        <div class="bg-white rounded-2xl border border-[#001644]/5 p-12 text-center">
            <div class="w-16 h-16 bg-[#001644]/8 rounded-2xl flex items-center justify-center mx-auto mb-4 text-2xl text-[#001644]"><i class="fas fa-book"></i></div>
            <h2 class="text-xl font-bold text-[#001644] mb-3">Educação Continuada</h2>
            <p class="text-sm text-[#001644]/60 max-w-lg mx-auto">Mantenha-se atualizado com o programa de educação continuada</p>
