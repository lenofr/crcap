...
$pageTitle  = 'Cursos Credenciados EPC';
$activePage = 'dev';
...
$page = dbQueryOne("SELECT * FROM pages WHERE slug = 'cursos-epc' AND status = 'published'");
include __DIR__ . '/../../includes/header.php';
$bannerTitle     = 'Cursos Credenciados EPC';
$bannerSubtitle  = 'Cursos reconhecidos pelo programa de educação profissional continuada';
$bannerIcon      = 'fa-certificate';
$bannerBreadcrumb = [['Home','/index.php'],['Des. Profissional',null],['Cursos Credenciados EPC',null]];
...
<div class="grid lg:grid-cols-4 gap-8">
    ...
    <div class="lg:col-span-3">
        ...
        <div class="bg-white rounded-2xl border border-[#001644]/5 p-12 text-center">
            <div class="w-16 h-16 bg-[#001644]/8 rounded-2xl flex items-center justify-center mx-auto mb-4 text-2xl text-[#001644]"><i class="fas fa-certificate"></i></div>
            <h2 class="text-xl font-bold text-[#001644] mb-3">Cursos Credenciados EPC</h2>
            <p class="text-sm text-[#001644]/60 max-w-lg mx-auto">Cursos reconhecidos pelo programa de educação profissional continuada</p>
