...
$page = dbQueryOne("SELECT * FROM pages WHERE slug = 'cursos-ead' AND status = 'published'");
include __DIR__ . '/../../includes/header.php';
$bannerTitle     = 'Cursos a Distância';
$bannerSubtitle  = 'EAD disponíveis para profissionais de Administração';
$bannerIcon      = 'fa-laptop';
$bannerBreadcrumb = [['Home','/index.php'],['Des. Profissional',null],['Cursos a Distância',null]];
...
<div class="grid lg:grid-cols-4 gap-8">
    ...
    <div class="lg:col-span-3">
        ...
        <div class="bg-white rounded-2xl border border-[#001644]/5 p-12 text-center">
            <div class="w-16 h-16 bg-[#001644]/8 rounded-2xl flex items-center justify-center mx-auto mb-4 text-2xl text-[#001644]"><i class="fas fa-laptop"></i></div>
            <h2 class="text-xl font-bold text-[#001644] mb-3">Cursos a Distância</h2>
            <p class="text-sm text-[#001644]/60 max-w-lg mx-auto">EAD disponíveis para profissionais de Administração</p>
