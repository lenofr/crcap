...
$pageTitle  = 'Atas – Desenvolvimento Profissional · CRCAP';
$activeMenu = 'atas';
$pageSlug   = 'atas-desenvolvimento';
$icon       = 'fa-file-signature';
$docType    = 'desenvolvimento';
...
<section class="bg-gradient-to-br from-[#001644] via-[#022E6B] to-[#001644] text-white py-12 relative overflow-hidden">
    ...
    <div class="container mx-auto px-4 relative z-10">
        <div class="flex items-center gap-2 text-white/50 text-xs mb-5">
            ...
            <i class="fas fa-chevron-right text-[9px]"></i>
            <span class="text-[#BF8D1A]">Atas – Desenvolvimento Profissional</span>
        </div>
        <div class="flex items-start gap-5">
            ...
            <div>
                <h1 class="font-serif text-3xl md:text-4xl font-bold mb-2">Atas – Desenvolvimento Profissional</h1>
                <p class="text-white/70 text-sm max-w-2xl">Registros oficiais das reuniões da Câmara de Desenvolvimento Profissional</p>
            </div>
        </div>
    </div>
</section>
